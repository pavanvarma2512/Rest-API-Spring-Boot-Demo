...
class CloudVendorControllerTest {
    ...
    void setUp() {
        ...
        cloudVendorTwo= new CloudVendor("2","Google","UK","YYYY");
    ...
    void testGetCloudVendorDetails() throws Exception {
        ...
        when(cloudVendorService.getCloudVendorDetails("1"))
    ...
    void testGetAllCloudVendorDetails() throws Exception{
        ...
        when(cloudVendorService.getAllCloudVendorDetails())
    ...
    @Test
    void testuUpdateCloudVendorDetails() throws Exception {
        ObjectMapper mapper = new ObjectMapper();
        mapper.configure(SerializationFeature.WRAP_ROOT_VALUE, false);
        ObjectWriter ow = mapper.writer().withDefaultPrettyPrinter();
        String requestJson=ow.writeValueAsString(cloudVendorOne);
